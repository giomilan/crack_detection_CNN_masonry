...
class Config:
    def __init__(self, working_folder):
        ...
        self.mode = 'train' #'build_data' # 'train', 'evaluate' or 'build_data'
    ...
    def set_repository(self):
        ...
        if self.mode == 'train':
            ...
            self.args['pretrained_filename'] = 'crack_detection_413480_epoch_1_F1_score_dil_0.114.h5'
