...
#Import black mask
mask_img=cv2.imread(main_folder+mask_img_dir,0)
...
number_of_imgs=len(os.listdir(main_folder+folder_imgs))

print('Number of imgs in the folder: '+ str(number_of_imgs))


writer = HDF5DatasetWriterMask((number_of_imgs, IMAGE_DIMS[0], IMAGE_DIMS[1], IMAGE_DIMS[2]), main_folder+hdf5_output)
...
for name_img in os.listdir(main_folder+folder_imgs):
